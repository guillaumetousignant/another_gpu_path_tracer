...
namespace AGPTracer { namespace Shapes {
    ...
    class Triangle_t {
        public:
             ...
             */
            Triangle_t(/*Material_t *material,*/ std::array<AGPTracer::Entities::Vec3<double>, 3> points, const std::optional<std::array<AGPTracer::Entities::Vec3<double>, 3>> normals, const std::optional<std::array<double, 6>> texcoord);
            ...
            std::array<AGPTracer::Entities::Vec3<double>, 3> points_orig_; /**< @brief Array of the three un-transformed points of the triangle, in counter-clockwise order. Transformed by the transform matrix on update to give points.*/
            std::array<AGPTracer::Entities::Vec3<double>, 3> normals_orig_; /**< @brief Array of the three un-transformed normals of the triangle, in counter-clockwise order. Transformed by the transform matrix on update to give normals.*/
